...
from os import stat
import api
module = api.v1.views.places_amenities


class TestStatesDocs(unittest.TestCase):
    """Class for testing /places/<place_id>/amenities Route docs"""
    ...
    def test_pep8(self):
        ...
        errors = pep8style.check_files(['api/v1/views/places_amenities.py'])
        self.assertEqual(errors.total_errors, 0, errors.messages)

    def test_file_is_executable(self):
        """... tests if file has correct permissions so user can execute"""
        file_stat = stat('api/v1/views/places_amenities.py')
